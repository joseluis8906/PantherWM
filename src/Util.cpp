...
std::string ToString(const XEvent &e) {
	...
	switch (e.type) {
		...
		case MapNotify:
			...
			properties.emplace_back("override_redirect", ToString(static_cast<bool>(e.xunmap.from_configure)));
			break;
		...
		case ConfigureRequest:
			...
			properties.emplace_back("value_mask", ToString(e.xconfigurerequest.value_mask));
